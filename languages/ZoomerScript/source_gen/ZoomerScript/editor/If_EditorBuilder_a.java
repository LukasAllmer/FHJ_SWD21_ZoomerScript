...
/*package*/ class If_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new conditionSingleRoleHandler_rrfgpz_b0(myNode, LINKS.condition$E5qj, getEditorContext());
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new trueBlockListHandler_rrfgpz_d0(myNode, getEditorContext());
  ...
  private static class trueBlockListHandler_rrfgpz_d0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public trueBlockListHandler_rrfgpz_d0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(trueBlockListHandler_rrfgpz_d0.this.getNode(), LINKS.trueBlock$LUxg));
      try {
